...
$profile = $controller->GetProfileByID($pID);
?>
...
<body>
    ...
    if (isset($_POST['updateProfile'])) {
        ...
        $updateResult = $controller->UpdateProfile($pID, $name, $description, $status);
        if ($updateResult) {
			header("Location: ../index.php?action=3_UserAdmin_Menu&msg=Profile updated successfully!");
        } else {
